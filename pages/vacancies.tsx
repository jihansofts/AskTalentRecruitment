...
const dummyJobs: JobData[] = [
  {
    ...
    vacancies: 5,
    description:
      "Installs and maintains electrical wiring and systems safely. Ensure compliance with building codes.",
    salary: "€700–€900",
    shift: "Day Shift",
    gender: "Male",
  ...
  },
  {
    ...
    vacancies: 20,
    description:
      "Provide high-quality patient care in intensive care units. Requires valid nursing license.",
    salary: "$2,000–$3,500",
  ...
  },
  {
    ...
    vacancies: 3,
    description:
      "Develop scalable web applications using React and Node.js. Lead a team of junior developers.",
  ...
  },
  {
    ...
    vacancies: 1,
    description:
      "Manage kitchen operations, develop menus, and ensure food quality in a 5-star hotel.",
  ...
  },
  {
    ...
    vacancies: 15,
    description:
      "Drive heavy haul trucks across borders. Must possess GCC valid heavy driving license.",
  ...
  },
  {
    ...
    vacancies: 8,
    description:
      "Repair and maintain heating, ventilation, and air conditioning systems in commercial buildings.",
  ...
  },
  {
    ...
    vacancies: 10,
    description:
      "Perform 6G welding on pipelines and offshore rigs. Must be certified and highly skilled.",
  ...
  },
  {
    ...
    vacancies: 2,
    description:
      "Analyze financial data, prepare reports, and assist in strategic financial planning.",
  ...
  },
  {
    ...
    vacancies: 4,
    description:
      "Oversee large-scale construction projects and ensure safety and structural integrity.",
  ...
  },
  {
    ...
    vacancies: 5,
    description:
      "Manage daily store operations, drive sales targets, and handle customer service excellence.",
...
export default function FindJobs() {
  ...
  return (
    <>
      <Head>
        <title>Featured Jobs - AskTalentRecruitment</title>
        <meta
          name="description"
          content="Discover AskTalentRecruitment's newest overseas job openings and career opportunities."
        />
      </Head>
        ...
        <section className="py-16 md:py-24 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
          <div className="mb-12 max-w-3xl" data-aos="fade-up">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              Our handpicked selection of top-tier international career
              opportunities, inviting you to take the next big step in your

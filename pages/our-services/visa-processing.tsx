...
export default function VisaProcessing() {
  return (
    <>
      <Head>
        <title>
          Visa Processing & Emigration - AskTalentRecruitment Manpower
        </title>
        <meta
          name="description"
          content="Expert handling of overseas work visas, GAMCA medicals, embassy attestations, and emigration clearances (BMET)."
        />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
            <div className="text-center max-w-4xl mx-auto mb-16 md:mb-24">
              ...
              <p className="text-gray-600 leading-relaxed text-lg">
                Finding the right candidate is only half the battle. The true
                bottleneck in overseas recruitment lies in the labyrinth of
                international visa requirements, mandatory medical clearances,
                and local government emigration policies. We handle this
                entirely in-house.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {steps.map((step, idx) => (
                <div
                  key={idx}
                  className="bg-white p-8 border border-gray-100 hover:border-brand-dark hover:shadow-xl transition-all duration-300 group"
                  data-aos="fade-up"
                  data-aos-delay={idx * 100}>
                  <step.icon className="w-12 h-12 text-brand-dark mb-6 group-hover:scale-110 transition-transform" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div data-aos="fade-left">
                ...
                <p className="text-gray-400 mb-6 leading-relaxed">
                  Every country has its own unique demands. Whether it&apos;s
                  Wakala / Enjaz systems for Saudi Arabia, specific biometrics
                  for the UAE, or strict medical quotas for Malaysia, our
                  processing teams stay updated on daily embassy changes.
                </p>
                <ul className="space-y-4 text-gray-300 mb-8">
                  <li className="flex items-start">
                    <ArrowRightIcon className="w-5 h-5 text-brand-dark mr-3 shrink-0 mt-0.5" />
                    <span>Tracking of individual medical report statuses</span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRightIcon className="w-5 h-5 text-brand-dark mr-3 shrink-0 mt-0.5" />
                    <span>
                      Direct embassy submissions to avoid third-party delays
                    </span>
                  </li>
                  <li className="flex items-start">
                    <ArrowRightIcon className="w-5 h-5 text-brand-dark mr-3 shrink-0 mt-0.5" />
                    <span>
                      Streamlined clearance routing for immediate flight booking
                    </span>
                  </li>
                </ul>
                <Link
                  ...
                  Speak with Our Processing Team{" "}

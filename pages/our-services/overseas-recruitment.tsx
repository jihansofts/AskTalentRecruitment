...
export default function OverseasRecruitment() {
  return (
    <>
      <Head>
        <title>Overseas Recruitment - AskTalentRecruitment Manpower</title>
        <meta
          name="description"
          content="End-to-end overseas recruitment from South Asia to the world. We specialize in deploying top talent to Middle Eastern and global markets."
        />
      </Head>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div data-aos="fade-right">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  For decades, South Asia has been the engine room of global
                  development. However, harnessing this talent requires
                  navigating complex regulatory frameworks, local customs, and
                  rigorous verification processes.
                </p>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  AskTalentRecruitment manages the entire recruitment
                  lifecycle—from executing your initial Demand Letter and
                  orchestrating nationwide advertising, to coordinating trade
                  tests, GAMCA Wafid medical checks, and final deployment. We
                  ensure that you receive competent workers who are legally
                  cleared and culturally prepared for the demands of working
                  abroad.
                </p>

                <Link
                  href="/hire-manpower/direct-recruitment"
                  className="inline-flex items-center justify-center bg-brand-dark hover:bg-brand-dark text-white px-8 py-4 font-bold tracking-widest uppercase transition-all shadow-lg hover:shadow-xl">
                  Initiate Demand
                </Link>
              </div>
              <div className="relative h-[600px] w-full" data-aos="fade-left">
                ...
                />
                {/* Overlay stat box */}
                <div className="absolute -bottom-8 -left-8 bg-white p-8 border-l-4 border-brand-dark shadow-xl max-w-xs hidden md:block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-4" data-aos="fade-right">
                ...
                <p className="text-gray-400 leading-relaxed mb-8">
                  We maintain active talent pools across essential industries,
                  ensuring rapid response times to your deployment schedules.
                </p>
              </div>
              <div className="lg:col-span-8" data-aos="fade-left">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {industries.map((industry, i) => (
                    <div
                      key={i}
                      className="flex items-center space-x-3 bg-white/5 p-4 rounded hover:bg-white/10 transition-colors">
                      <CheckCircleIcon className="w-6 h-6 text-brand-dark" />
        ...
        <section className="py-24 bg-brand-dark text-center">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <p className="text-[#b4e7ed] mb-10 text-lg">
              Get in touch to discuss your specific manpower needs and request a
              deployment timeline.
            </p>
            <Link
              href="#"
              className="inline-block bg-white text-brand-dark font-bold uppercase tracking-widest py-4 px-10 hover:bg-brand-dark hover:text-white transition-colors">
              Get In Touch
            </Link>
          </div>
        </section>

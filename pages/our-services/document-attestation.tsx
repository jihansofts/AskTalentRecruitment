...
export default function DocumentAttestation() {
  return (
    <>
      <Head>
        <title>Document Attestation - AskTalentRecruitment Manpower</title>
        <meta
          name="description"
          content="Fast and reliable document attestation services for foreign embassies, Ministry of Foreign Affairs, and Notary Public."
        />
      </Head>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div data-aos="fade-right">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Before a single worker can be mobilized, the legal framework
                  must be established between the host country employer and the
                  source country. This requires rigorous authentication of
                  company documents.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Simultaneously, skilled professionals (engineers, nurses,
                  managers) must have their qualifications verified by specific
                  government bodies to secure their work visas. We handle this
                  entire chain of custody to ensure zero rejections at the
                  embassy.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {attestationTypes.map((type, idx) => (
                <div
                  key={idx}
                  className="bg-white p-8 border-t-4 border-brand-dark shadow-sm hover:shadow-lg transition-shadow"
                  data-aos="fade-up"
                  data-aos-delay={idx * 100}>
                  <type.icon className="w-10 h-10 text-brand-dark mb-6" />
        ...
        <section className="py-20 bg-brand-dark text-white text-center">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="text-gray-400 mb-10">
              If you are an employer looking to issue Demand Letters, we can
              guide you through the attestation requirements for your specific
              country consulate.
            </p>
            <Link
              href="#"
              className="inline-block border-2 border-brand-dark text-white hover:bg-brand-dark font-bold uppercase tracking-widest py-4 px-10 transition-colors">
              Contact Legal Team
            </Link>
          </div>
        </section>

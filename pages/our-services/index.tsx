...
const processSteps = [
  {
    ...
    desc: "Provide us your job descriptions and Demand Letters. We will initiate local embassy approvals.",
  },
  {
    num: "02",
    title: "We Source & Trade-Test",
    desc: "Our experienced team mobilizes our network, pre-screens applicants, and conducts rigorous testing.",
  },
  {
    num: "03",
    title: "You Select Candidates",
    desc: "Review CVs and conduct interviews either virtually or at our dedicated facilities.",
  },
  {
    num: "04",
    title: "We Process Visas & Medicals",
    desc: "We take over the entire labyrinth of Wafid/GAMCA medicals, visa stamping, and clearance.",
  },
  {
    num: "05",
    title: "Deployment & Follow-up",
    desc: "Workers fly out after comprehensive training; we ensure safe arrival and swift onboarding.",
  },
];
...
export default function OurServices() {
  return (
    <>
      <Head>
        <title>Our Services - AskTalentRecruitment</title>
        <meta
          name="description"
          content="Comprehensive overseas manpower solutions. From recruitment and trade testing to visa processing and document attestation."
        />
      </Head>
      <main className="min-h-screen bg-[#f7f5f2]">
        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 text-center">
            ...
            <p
              className="text-gray-600 text-sm md:text-base max-w-3xl mx-auto leading-relaxed"
              data-aos="fade-up"
              data-aos-delay="100">
              Hiring overseas can be an administrative nightmare. At
              AskTalentRecruitment, we act as your trusted bridge to South
              Asia&apos;s vast workforce. With end-to-end services encompassing
              precise talent sourcing, rigorous trade testing, bulletproof
              compliance, and seamless logistics, we ensure your workforce
              arrives on site, on time, and fully prepared.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <Link
                  key={index}
                  href={service.href}
                  className="group bg-white flex flex-col border border-gray-200 hover:border-brand-dark hover:shadow-xl transition-all duration-500 overflow-hidden"
                  data-aos="fade-up"
                  ...
                  <div className="p-8 flex flex-col grow">
                    <h3 className="text-xl font-bold text-brand-dark mb-4 group-hover:text-brand-dark transition-colors">
                      {service.title}
                    </h3>
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 grow">
                      {service.desc}
                    </p>
                    <div className="flex items-center text-brand-dark font-bold text-xs tracking-widest uppercase mt-auto">
                      Learn More
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
            <div className="mb-16 md:mb-24 text-center" data-aos="fade-up">
              ...
              <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto">
                A battle-tested methodology designed to move candidates through
                complex governmental funnels and onto your worksite.
              </p>
            </div>
              ...
              <div className="space-y-12 md:space-y-0 relative">
                {processSteps.map((step, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="relative flex items-center md:justify-between w-full pb-8 md:pb-24 last:pb-0"
                      data-aos="fade-up">
                      {/* Center Line Marker */}
                      <div className="absolute left-0 md:left-1/2 w-8 h-8 rounded-full bg-brand-dark border-2 border-brand-dark -translate-x-1/2 z-10 flex items-center justify-center">

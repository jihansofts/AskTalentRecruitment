...
export default function PreDepartureOrientation() {
  return (
    <>
      <Head>
        <title>Pre-Departure Orientation - AskTalentRecruitment Manpower</title>
        <meta
          name="description"
          content="Mandatory pre-departure training and orientation to ensure candidates are culturally and professionally prepared for overseas deployment."
        />
      </Head>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2" data-aos="fade-left">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Moving across borders to work in an unfamiliar environment is
                  daunting. Our mandatory Pre-Departure Orientation (PDO) is a
                  vital step approved by the Bureau of Manpower.
                </p>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  A well-informed worker is a productive worker. We mitigate the
                  risks of homesickness, cultural violations, and safety
                  breaches by formally educating candidates on exactly what to
                  expect from their new life and employing company.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              {curriculum.map((item, idx) => (
                <div
                  key={idx}
                  className="flex flex-col md:flex-row gap-6 border-l-2 border-gray-100 pl-6 hover:border-brand-dark transition-colors"
                  data-aos="fade-up"

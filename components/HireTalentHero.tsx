...
const slidesData = [
  {
    id: 1,
    title: "Reliable South Asian Workforce",
    subtitle: "Workforce",
    description:
      "Source highly skilled, trade-tested, and dedicated professionals from South Asia for your global workforce needs. We connect employers with reliable talent ready to contribute from day one.",
    image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg",
    link: "/hire-manpower/direct-recruitment",
  },
  {
    id: 2,
    title: "End-to-End Recruitment & Deployment",
    subtitle: "Processing",
    description:
      "We manage the entire recruitment lifecycle so you can focus on your operations. From candidate sourcing and strict screening to visa processing, medical clearance, and final deployment — AskTalentRecruitment ensures a seamless, compliant process every step of the way.",
  ...
  },
  {
    ...
    description:
      "Efficiently meet your short-term or large-scale manpower demands with confidence. Whether you need a few specialists or bulk recruitment for major projects, we deliver fast, compliant, and cost-effective staffing solutions.",

...
export default function ServicesSubNav() {
  return (
    <section className="bg-brand-dark py-6 md:py-8 border-b-4 border-brand-dark sticky top-0 md:static z-20 shadow-md">
        ...
        <nav className="flex flex-col md:flex-row md:items-center">
          ...
          <ul className="flex overflow-x-auto pb-2 md:pb-0 gap-8 md:gap-10 text-white text-sm font-semibold tracking-wide whitespace-nowrap scrollbar-hide">
            <li>
              <Link
                href="/our-services"
                className="hover:text-[#b4e7ed] hover:-translate-y-1 transition-all flex items-center gap-2">
            ...
            <li>
              <Link
                ...
                className="hover:text-[#b4e7ed] hover:-translate-y-1 transition-all">
                Recruitment
              </Link>
            </li>
            <li>

          ...
          >
            {cards.map((card) => (
              <SwiperSlide key={card.id} className="h-full">
                <Link href="/vacancies" className="h-full">
                  <div className="relative w-full h-full group/card overflow-hidden cursor-pointer">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center transition-opacity duration-500 group-hover/card:opacity-0 z-10">
                      <div className="text-center text-white drop-shadow-md">
                        ...
                        <h3 className="text-2xl font-light tracking-[0.2em] uppercase">
                          {card.title}
                        </h3>
                    ...
                    <div
                      className={`absolute inset-0 ${hoverBgColorClassName} translate-y-full group-hover/card:translate-y-0 transition-transform duration-500 ease-in-out flex flex-col items-center justify-center p-8 text-center z-20`}>
                      {/* Hover Logo */}
                      <div className="absolute top-16 text-center text-white">
                        ...
                        <p className="text-[10px] tracking-[0.3em] uppercase mt-1 text-[#e2dbc8]">
                          {card.subtitle}
                        </p>
                      </div>

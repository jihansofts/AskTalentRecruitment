...
const slidesData = [
  {
    id: 1,
    surtitle:
      "Discover global career opportunities with complete support from application to deployment.",
    title: "AskTalentRecruitment – Your Trusted Pathway to Work Abroad",
    position: "left",
    videoUrl:
  ...
  },
  {
    id: 2,
    surtitle:
      "At AskTalentRecruitment, we ensure a smooth, transparent, and stress-free journey to your international career.",
    title: "Secure Overseas Placements & Complete Visa Support",
    position: "left",
    videoUrl:
      "https://videos.pexels.com/video-files/853889/853889-hd_1920_1080_25fps.mp4",
  },
  {
    id: 3,
    surtitle:
      "We bridge skilled talent with trusted international employers across high-demand industries.",
    title: "Empowering South Asian Professionals for Global Success",
    position: "right",
    videoUrl:
      "https://videos.pexels.com/video-files/853889/853889-hd_1920_1080_25fps.mp4",
    link: "/hire-manpower",
              ...
              <div
                ...
                className={`relative flex flex-col justify-end px-4 md:px-10 pb-12 h-full cursor-pointer transition-all duration-700 ease-in-out border-r border-white/10 last:border-r-0 ${
                  isActive
                    ...
                    : "w-0 md:w-1/4 hidden md:flex"
                } ${
                  !isActive
                    ? "bg-linear-to-t from-brand-dark/80 via-brand-dark/20 to-transparent hover:from-brand-dark-border/80"
                ...
                {isActive ? (
                  <div
                    key={`active-${i}`}
                    className="animate-slide-up-fade flex flex-col items-center text-center md:items-start md:text-left">
                    <p className="text-white/90 text-[10px] md:text-lg uppercase tracking-wider mb-2">
                      {data.title}
                    </p>
                    <p className="text-3xl md:text-5xl lg:text-6xl text-white leading-tight mb-4">
                      {data.surtitle}
                    </p>
                    {data.link && (
                      <a
                  ...
                  <div
                    key={`inactive-${i}`}
                    className="animate-slide-up-fade flex flex-col items-center text-center md:items-start md:text-left">
                    <p className="text-white text-[10px] md:text-xl uppercase tracking-wider">
                      {data.title}
                    </p>
                  </div>
                )}
